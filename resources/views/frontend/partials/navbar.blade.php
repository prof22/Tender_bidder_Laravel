      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="{{ route('allTender') }}">View Open Contract</a>
            <a class="dropdown-item" href="{{ route('allTender') }}">Bid for Contract</a>
            <a class="dropdown-item" href="{{ route('allTender') }}">Edit Bid Document</a>
          </div>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="{{ route('allTender') }}">Bid Members</a>
        </li>
        @endif
     @endif
        @if(Auth::guard('web')->check())
        @if(Auth::guard('web')->user()->account_role == 'tenderer')
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="{{ route('user.tender.index') }}">Contract </a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="{{ route('user.tender.elevationForm') }}">Evaluation Form </a>
                <a class="dropdown-item" href="{{ route('user.tender.evaluation') }}">Evaluation Report </a>
