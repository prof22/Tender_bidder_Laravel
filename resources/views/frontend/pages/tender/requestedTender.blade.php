      ...
      @foreach ($tenders as $tender)
        <div class="single-tender pointer">
          ...
          <div class="float-right">
            <a href="" class="btn btn-outline-secondary">Document Price: <span class="price">N{{ $tender->tender->document_price }}</span></a>
            <a href="" class="ml-2 btn btn-outline-info">Security Amount: <span class="price">N{{ $tender->tender->security_amount }}</span></a>
          </div>
          <div class="clearfix"></div>
          ...
          @elseif($tender->approved == 2)
            <a class="btn btn-sm btn-danger float-right mt-3 mr-1">Rejected</a>
            @elseif($tender->approved == 3)
            <a class="btn btn-sm btn-info float-right mt-3 mr-1">Ongoing</a>
            @elseif($tender->approved == 4)
            <a class="btn btn-sm btn-secondary float-right mt-3 mr-1">Pending</a>
          @else
